...
public class ConsumerSimpleDemo extends Thread {
	...
	private static ConsumerConfig createConsumerConfig() {
		...
		props.put("zookeeper.connect", "192.168.113.132:2180,192.168.113.132:2181,192.168.113.132:2182");
		// 配置zookeeper的组id
	...
	public static void main(String[] args) {
		ConsumerSimpleDemo consumerThread = new ConsumerSimpleDemo("test1");
